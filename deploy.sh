...
echo "4. New 'Site Manager' role has been added, with the ability to manage producers only"
echo "5. Test accounts have been created: admin/admin123, sitemanager/sitemanager123, producer/producer123"
echo ""
