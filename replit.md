...
- June 24, 2025: ENHANCED Day Chronological View booking cards - upgraded hover cards to display comprehensive booking information including status indicators with icons (confirmed/tentative/cancelled), notification group names instead of IDs, booking color information, creation timestamps, and improved layout organization for better user experience
