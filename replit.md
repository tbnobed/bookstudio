...
- June 24, 2025: ENHANCED signage display with accurate timezone and weather - fixed Central Time display to show correct local time (was showing UTC), added OpenWeatherMap integration for Dallas area weather with temperature, conditions, humidity, and wind speed updating every 10 minutes
