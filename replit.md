...
- June 28, 2025: ENHANCED engineering calendar booking readability - significantly increased text sizes and spacing for better visibility, upgraded booking titles to text-lg (18px) with font-bold, increased all detail text to text-base (16px) with font-medium, expanded container padding to p-3, added helpful visual icons (📹 studios, 🖥️ PCR rooms, 🕐 times, 📋 status), improved opacity levels for maximum readability at first glance
