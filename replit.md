...
- June 26, 2025: OPTIMIZED TV signage for 1920x1080 displays - increased all font sizes and padding for better readability from distance viewing, enhanced facility name to 56px, section titles to 28px, booking titles to 16px, alert text to 20px, studio names to 18px, and improved overall spacing and contrast for professional TV display presentation
