...
- June 24, 2025: FIXED signage display data access - added public /api/public/bookings endpoint to allow signage displays to access booking data without authentication, ensuring facility monitors can display current schedule information
