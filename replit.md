...
- June 24, 2025: OPTIMIZED studio status display for no-scroll viewing - redesigned studio status section to use 2-column grid layout with compact cards showing studio name, status indicator, and availability time in stacked format, ensuring all studios visible without scrolling on signage monitors
