...
- June 24, 2025: OPTIMIZED studio status display for no-scroll viewing - redesigned studio status section to display all studios in compact grid layout with smaller text and truncated availability times, ensuring complete studio overview without scrolling on signage monitors
