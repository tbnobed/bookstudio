...
- June 24, 2025: REPLACED weather details with active site alerts - removed weather information display and added consolidated Active Site Alerts section showing only maintenance-type activities and alerts, filtering out regular bookings from facility safety notifications to avoid confusion between operational bookings and actual maintenance alerts
