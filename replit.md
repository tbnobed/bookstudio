...
- June 24, 2025: FIXED signage display timezone - corrected Central Time display to show accurate local time (5:25 PM CST instead of 7:25 PM UTC) using JavaScript Intl API for reliable timezone conversion, added weather integration framework ready for valid OpenWeatherMap API key
