...
- June 24, 2025: REPLACED weather details with active site alerts - removed weather information display and added Active Site Alerts section for facility-wide emergency alerts only, separating scheduled maintenance bookings (which appear in Today's Schedule) from actual facility alerts to avoid confusion between normal operations and emergency notifications
