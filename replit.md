...
- June 24, 2025: IMPLEMENTED OpenWeatherMap One Call API 3.0 with fallback - integrated premium weather service for Dallas area with fallback to free API, displays temperature, humidity, wind speed, and weather conditions on signage display with 10-minute updates for facility operations planning
