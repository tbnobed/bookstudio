...
function PublicCalendarPage() {
  ...
  return (
    <div className="flex h-screen flex-col bg-background">
      {/* Header */}
      <header className="sticky top-0 z-30 border-b bg-[#003366] shadow-sm h-12 flex items-center justify-center">
        <img src={logoPath} alt="BookStud.io logo" className="h-8 w-auto" />
      </header>
