...
export function MobileBanner() {
  ...
  return (
    <div className="relative">
      ...
      {/* Logo on separate layer floating above banner */}
      ...
      {/* Extended fade effect with space for floating logo */}
      <div className="h-32 bg-gradient-to-b from-blue-100/60 via-blue-50 to-transparent"></div>
    </div>
  );
}